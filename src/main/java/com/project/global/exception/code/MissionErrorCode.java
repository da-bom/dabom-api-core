...
public enum MissionErrorCode implements BaseErrorCode {
    ...
    MISSION_INVALID_STATUS_TRANSITION(HttpStatus.BAD_REQUEST, "MISSION_004", "미션 상태 전이가 유효하지 않습니다."),
    ...
    MISSION_REWARD_CATEGORY_MISMATCH(HttpStatus.BAD_REQUEST, "MISSION_014", "보상 카테고리가 템플릿과 일치하지 않습니다.");
